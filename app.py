...
app.layout = html.Div(children=[
    dbc.Row([
        ...
        dbc.Col(
            html.H3(children="Tableau De Bord De Suivi Consommation Carburant Coordination Carto RGPH-5",
                                    style={'text-align': 'center', 'border': 'solid', 'color': '#33C6FF'}),
            width=11
            )
